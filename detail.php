...
$payer->name = "Lalo";
$payer->surname = "Landa";
$payer->email = "test_user_20894273@testuser.com";// éste caducó: "test_user_63274575@testuser.com";
$payer->phone = array(
    "area_code" => "11",
    "number" => "22223333"
);
...
$item->picture_url = "https://gdivenuto-mp-commerce-php.herokuapp.com/".$_POST['img'];
...
$preference->notification_url = "https://gdivenuto-mp-commerce-php.herokuapp.com/webhook.php";
...
?>
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <form action="https://gdivenuto-mp-commerce-php.herokuapp.com/procesar-pago.php" method="POST">
                                        <script
